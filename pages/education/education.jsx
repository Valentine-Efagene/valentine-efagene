        ...
        <div className={styles.courseCards}>
          ...
          <GlassCard>
            <div class={styles.cardContent}>
              ...
              <p>
                My training in engineering mathematics has helped me avoid trail
                and eror, and use more systematic approaches to problems, and
                also to reduce complex problems to simple equations.
              </p>
              <a href="#">Read More</a>
            </div>
          </GlassCard>
          ...
          <GlassCard>
            <div class={styles.cardContent}>
              ...
              <p>
                I was introduced to assembly language and bytecode programming.
                I am actually an x86_64 assembly programmer today.
              </p>
              <a href="#">Read More</a>
            </div>
          </GlassCard>
